    ...
    <section className="bg-gradient-to-br from-apzumi-dark to-[#1a2350] text-white pt-32 pb-16 px-6 relative overflow-hidden min-h-[60vh] flex items-center">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <button className="bg-gradient-to-r from-apzumi-red to-rose-500 hover:brightness-110 text-white font-semibold py-4 px-8 rounded-full flex items-center gap-2 transition-all transform hover:scale-105 shadow-lg shadow-apzumi-red/30">
